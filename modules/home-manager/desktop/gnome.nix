...
let
  ...
  bindings =
    let
      bindingsList = mapAttrsToList (binding: command: {
  ...
  config = mkIf cfg.enable (mkMerge [
    {
      ...
      gtk = {
        ...
        theme = {
          name = if cfg.themeVariant == "light" then "adw-gtk3" else "adw-gtk3-dark";
      ...
      qt = {
        ...
        platformTheme = "gnome";
        style = {
          name = if cfg.themeVariant == "light" then "adwita" else "adwaita-dark";
